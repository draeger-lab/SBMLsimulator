...
public class SettingsPanelGeneral extends SettingsPanel implements
	...
	public void init() {
		...
		JButton openButton = GUITools.createButton(GUITools.getIconFolder(),
				this, Command.OPEN, String.format(toolTipButtons, "open"));
		JButton saveButton = GUITools.createButton(GUITools.getIconSave(),
				this, Command.SAVE, String.format(toolTipButtons, "save"));
