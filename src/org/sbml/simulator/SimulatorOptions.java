...
public interface SimulatorOptions extends KeyProvider {
     ...
     * {@link AbstractDESSolver} and must have a constructor
	...
	Double.valueOf(1E3));
    /**
     * Decide whether or not by default all local parameters in
	...
	Boolean.TRUE);
    /**
     * Decide whether or not by default all global parameters
	...
	Boolean.TRUE);
    /**
     * Decide whether or not by default all compartments in a
	...
	Boolean.FALSE);
    /**
     * Decide whether or not by default all species in a model
	...
	Boolean.FALSE);
    /**
     * Decide whether a model calibration should be done using
