...
public class SBMLinterpreter implements ASTNodeCompiler, EventDESystem,
	...
	// TODO: also treat SpeciesReferences here!
	...
	// TODO: Save values of SpeciesReferences!
	...
	for (i = 0; i < model.getNumReactions(); i++) {
		...
		if (model.getReaction(i).getKineticLaw().getListOfLocalParameters()
			.size() > 0) {
