...
public class SimulatorUI extends JFrame implements ActionListener,
	...
	case HELP_ABOUT:
	    GUITools
		    .showMessage(Resource.class.getResource("html/about.html"),
			"About SBMLsimulator "
	...
	case HELP_LICENSE:
		...
		"License of SBMLsimulator " + SBMLsimulator.getVersionNumber(),
		this, GUITools.getIconLicense48());
	    break;
	case OPTIMIZATION:
	...
	JMenuItem exitItem = GUITools.createJMenuItem(this, Command.EXIT,
	...
	JMenuItem help = GUITools.createJMenuItem(this, Command.HELP_ONLINE,
	    GUITools.getIconHelp(), KeyStroke.getKeyStroke(KeyEvent.VK_F1, 0));
	JMenuItem about = GUITools.createJMenuItem(this, Command.HELP_ABOUT,
	    GUITools.getIconInfo(), KeyStroke.getKeyStroke(KeyEvent.VK_F2, 0));
	...
	SBPreferences prefs = SBPreferences.getPreferencesFor(GUIOptions.class);
	openModel(GUITools.openFileDialog(this, prefs.get(GUIOptions.OPEN_DIR)
		.toString(), false, false, JFileChooser.FILES_ONLY,
	    SBFileFilter.SBML_FILE_FILTER));
    }
	...
	if (e.getSource() instanceof JFrame) {
		...
		GUITools.setEnabled(true, getJMenuBar(), toolbar,
		    ...
		    Command.CLOSE_DATA, Command.OPTIMIZATION, Command.SETTINGS);
	    }
	}
    }
