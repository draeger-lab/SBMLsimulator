...
public class SimulationToolPanel extends JPanel implements ItemListener,
  ...
  public void loadPreferences() throws IllegalArgumentException,
    ...
    maxTime = Math.max(prefsSimulation
        .getDouble(SimulationOptions.SIM_MAX_TIME), Math.max(
  ...
  public void setStepSize(double stepSize) {
    this.firePropertyChange("stepSize", simulationConfiguration.getStepSize(),
      stepSize);
    this.stepsModel.setValue(Integer.valueOf(numSteps(((Number) t1.getValue())
        .doubleValue(), ((Number) t2.getValue()).doubleValue(), stepSize)));
  }
