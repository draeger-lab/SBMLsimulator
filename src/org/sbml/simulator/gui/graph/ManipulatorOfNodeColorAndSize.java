...
public class ManipulatorOfNodeColorAndSize extends AGraphManipulator{
     ...
     */
    public ManipulatorOfNodeColorAndSize(SBML2GraphML graph, SBMLDocument document,
     ...
     */
    public ManipulatorOfNodeColorAndSize(SBML2GraphML graph,
    ...
    public void dynamicChangeOfNode(String id, double value, boolean labels) {
        if (id2speciesNode.get(id) != null) {
            ...
            double size = adjustValue(id2minMaxData.get(id)[0],
                    id2minMaxData.get(id)[1], minNodeSize, maxNodeSize, value);
