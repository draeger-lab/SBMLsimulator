...
/**
 * A modification of the class from the underlying plotting library that changes
 * the display a little bit and provides an adaptation to the data sets used
 * in this program.
 * 
...
org.jfree.chart.renderer.xy.XYBoxAndWhiskerRenderer {
  ...
  public void setArtifactPaint(int series, Paint paint, boolean notify) {
    artifactPaintList.setPaint(series, paint);
    if (notify) {
      fireChangeEvent();
    }
  }
